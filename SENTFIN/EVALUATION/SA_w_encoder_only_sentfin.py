...
def main():
    ...
    #PREDICT SENTIMENT
    dataset_path = f'{path}/OUTPUT/sentfin_enriched_v1_allagree_FAST.csv'
    ...
    output.to_csv(f'{path}/output/output_financial_db_decoder_only_v1_FAST_v2_sentfin.csv')
    ...
    output_sentences.to_csv(f'{path}/OUTPUT/check_sentences_enriched_for_decoder_only_evaluator_sentfin.csv')
